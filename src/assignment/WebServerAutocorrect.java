 ...
 */
public class WebServerAutocorrect {
    ...
    public static void main(String[] args) throws Exception {
        WebQueryEngineAutocorrect wqea = WebQueryEngineAutocorrect.fromIndex(
                (WebIndex) Index.load("index.db"));
        WebServerAutocorrect server = new WebServerAutocorrect(wqea);

        server.serve();
    }

    private WebQueryEngineAutocorrect engine;

    public WebServerAutocorrect(WebQueryEngineAutocorrect wqea) {
        engine = wqea;
    }
