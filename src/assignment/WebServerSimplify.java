 ...
 */
public class WebServerSimplify {
    ...
    public static void main(String[] args) throws Exception {
        WebQueryEngineSimplify wqe = WebQueryEngineSimplify.fromIndex(
                (WebIndex) Index.load("index.db"));
        WebServerSimplify server = new WebServerSimplify(wqe);

        server.serve();
    }

    private WebQueryEngineSimplify engine;

    public WebServerSimplify(WebQueryEngineSimplify wqes) {
        engine = wqes;
    }
    ...
    private void renderSearchResults(BufferedWriter out,
        ...
        content+= "simplified query: " + String.join(" ", engine.simplifiedTokens);
    ...
    private String layoutPageContent(Page p) {
        return "<p>" + "<a href='" + p.getURL() + "'>" + p.getURL() + "</a>" + "<br>" + p.getTitle() + "<br>" + p.getRank() + "</p>";
    }
