 ...
 * TODO: Implement this!
 */
public class WebQueryEngineAutocorrect {
    ...
    public WebQueryEngineAutocorrect(){
        this.index = index;
        autocorrected = false;
        correctedTokens = new ArrayList<>();
    }

    public WebQueryEngineAutocorrect(WebIndex index){
        this.index = index;
        autocorrected = false;
        correctedTokens = new ArrayList<>();
    }
     ...
     */
    public static WebQueryEngineAutocorrect fromIndex(WebIndex index) {
        // TODO: Implement this!
        return new WebQueryEngineAutocorrect(index);
    }
